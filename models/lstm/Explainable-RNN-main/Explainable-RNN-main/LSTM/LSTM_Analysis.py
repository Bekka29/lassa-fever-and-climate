...
plt.xlabel("Day") 
fig3.savefig('Results\\LSTM_Noise.pdf',dpi=900)
...
plt.xlabel("Day") 
fig4.savefig('Results\\LSTM_Noise_log.pdf',dpi=900)
...
fig9.savefig('Results\LSTM_Attributions_log_abs.pdf')
